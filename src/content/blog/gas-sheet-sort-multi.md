...
こんにちは、病棟勤務のかたわらGASをいじっている凛です。スプレッドシートで売上や優先度の表を並べ替えるとき、「降順にして、さらに日付順で…」と何度もクリックしているうちに、列の位置を見失ってしまうことってありませんか。私はこの手作業を一度自動化してから、表を開くたびに完璧に並んでいる状態が当たり前になりました。
