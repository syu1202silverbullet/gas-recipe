...
こんにちは、病棟勤務のかたわらGASをいじっている凛です。仕事のシフト、子どもの行事、副業の打ち合わせ——気づけばカレンダーが真っ白な予定でびっしり埋まり、どれが何の用事なのかパッと見では区別がつかなくなっていました。種類ごとに色を付ければ見やすいのは分かっていても、手で塗り分ける作業はなかなか続きません。そこで予定のタイトルから自動で色を振り分けるGASを組んでみました。

今回のテーマは「Googleカレンダーの予定を自動で色分けするGAS」です。

色分けの判断基準は、たいてい予定のタイトルに表れています。「会議」なら青、「通院」なら赤、というルールさえ決めてしまえば、あとは機械的に振り分けられるはず。人の手で塗り続ける代わりに、このルールをGASに覚えさせるのが今回のアプローチです。
