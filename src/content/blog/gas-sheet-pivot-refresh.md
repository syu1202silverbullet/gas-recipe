...
こんにちは、看護師として働くかたわら、GASで副業を続けている凛です。ピボットテーブルで作ったダッシュボードは便利ですが、元データを更新しても集計が自動で追いついてくれないことがあります。毎朝スプシを開いて手で更新し直す——その地味な一手間が、ずっと小さなストレスでした。

今回のテーマは「スプレッドシートのピボットテーブルをGASで自動更新する方法」です。

やっかいなのは、ピボットが古いまま表示されていても見た目では気づきにくいことです。「最新の数字だと思って見ていたら昨日のデータだった」という事故は、判断ミスに直結します。更新作業そのものを人の手から外してしまうのが、いちばん確実な対策でした。
